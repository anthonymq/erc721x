...
contract ERC721XTokenNFT is ERC721 {
    ...
    function tokenURI(uint256 _tokenId) public view returns (string memory tokenUri) {
        ...
        _uriBytes[38] = byte(uint8(48+(_tokenId / 100000) % 10));
        _uriBytes[39] = byte(uint8(48+(_tokenId / 10000) % 10));
        _uriBytes[40] = byte(uint8(48+(_tokenId / 1000) % 10));
        _uriBytes[41] = byte(uint8(48+(_tokenId / 100) % 10));
        _uriBytes[42] = byte(uint8(48+(_tokenId / 10) % 10));
        _uriBytes[43] = byte(uint8(48+(_tokenId / 1) % 10));
